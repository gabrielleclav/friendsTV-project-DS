...
## Conclusion 
This project was a really fun project to do. I love natural langauge processing and machine learning, so I put both together for this project. I realized with the modeling process that it is definitely difficult to have perfect models, since predicting from a langauge is not the easiest. I also realized that modeling a multiclassification is difficult to work with and harder to get better results. Being said that, I learned a lot from this project and no matter how much I wanted my models to do better, it did better than the baseline model and I am happy with the final result. I hope you enjoy exploring this preoject and the web application!  